...
-- atualizado_por = e-mail do admin que fez a última alteração (auditoria).
...
-- origem = 'robo' (agendado) | 'admin' (botão "Atualizar equipes") (auditoria).
CREATE TABLE IF NOT EXISTS setor_equipes (
  setor    VARCHAR(50)  NOT NULL,
  equipe   VARCHAR(255) NOT NULL,
  origem   VARCHAR(20)  NOT NULL DEFAULT 'robo',
